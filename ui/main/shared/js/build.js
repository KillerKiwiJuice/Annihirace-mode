console.log("loading annihirace mod");
...
var Build = (function () {
    ...
    var HotkeyModel = function () {
        ...
        if (!(decode(localStorage.getItem('orbitalEnabled')) && decode(localStorage.getItem('t2AirEnabled')) && decode(localStorage.getItem('nukeEnabled')))) {
        ...
        if (decode(localStorage.getItem('nukeEnabled'))) {
        ...
        if (decode(localStorage.getItem('t2AirEnabled'))) {
            self.SpecIdToGridMap = ko.observable({
                "/pa/units/land/titan_structure/titan_structure.json": ["utility", 0],
                    "/pa/units/land/control_module/control_module.json": ["utility", 1],
                    "/pa/units/land/radar_adv/radar_adv.json": ["utility", 8],
        ...
        if (decode(localStorage.getItem('orbitalEnabled'))) {
            self.SpecIdToGridMap = ko.observable({
                "/pa/units/land/titan_structure/titan_structure.json": ["utility", 0],
                    "/pa/units/land/control_module/control_module.json": ["utility", 1],
                    "/pa/units/land/radar_adv/radar_adv.json": ["utility", 8],
        ...
        if (decode(localStorage.getItem('nukeEnabled')) && decode(localStorage.getItem('t2AirEnabled'))) {
            self.SpecIdToGridMap = ko.observable({
                "/pa/units/land/titan_structure/titan_structure.json": ["utility", 0],
                    "/pa/units/land/control_module/control_module.json": ["utility", 1],
                    "/pa/units/land/radar_adv/radar_adv.json": ["utility", 8],
        ...
        if (decode(localStorage.getItem('nukeEnabled')) && decode(localStorage.getItem('t2AirEnabled')) && decode(localStorage.getItem('orbitalEnabled'))) {
            self.SpecIdToGridMap = ko.observable({
                "/pa/units/land/titan_structure/titan_structure.json": ["utility", 0],
                    "/pa/units/land/control_module/control_module.json": ["utility", 1],
                    "/pa/units/land/radar_adv/radar_adv.json": ["utility", 8],
        ...
        if (decode(localStorage.getItem('nukeEnabled')) && decode(localStorage.getItem('orbitalEnabled'))) {
            self.SpecIdToGridMap = ko.observable({
                "/pa/units/land/titan_structure/titan_structure.json": ["utility", 0],
                    "/pa/units/land/control_module/control_module.json": ["utility", 1],
                    "/pa/units/land/radar_adv/radar_adv.json": ["utility", 8],
        ...
        if (decode(localStorage.getItem('orbitalEnabled')) && decode(localStorage.getItem('t2AirEnabled'))) {
            self.SpecIdToGridMap = ko.observable({
                "/pa/units/land/titan_structure/titan_structure.json": ["utility", 0],
                    "/pa/units/land/control_module/control_module.json": ["utility", 1],
                    "/pa/units/land/radar_adv/radar_adv.json": ["utility", 8],
...
console.log("finished loading annihirace mod");